    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card">
                    <div class="card-header bg-success text-center" >Add Sub Category</div> 
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        <form action="{{url('add-subcategory-post')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('subcategory_name') }}" name="subcategory_name" class="form-control .@error('subcategory_name') is-invalid @enderror" id="subcategory_name" placeholder="Enter Sub Category Name">
